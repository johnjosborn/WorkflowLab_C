...
if (isset($_GET['email']) && isset($_GET['t'])){
    ...
    if($result->num_rows == 0){
        ...
        $verStatus = $row['USR_ver']; 

        //check to see if this account has been verified
        if ($verStatus == 1){
            ...
            if ($existingVer == $token) {
                ...
                $message = "<table>
                    <thead>
                        <tr>
                            <th colspan='2'>Account not verified.</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>The account for the following email has not been verified.</td>
                        </tr>
                        <tr>
                            <td><input type='email' id='email' class='regInput' value='$email' readonly></td>
                        </tr>
                        <tr>
                            <td>Try the verification link in your email again or</td>
                        </tr>
                        <tr>
                            <td><input type='button' onclick='resendVerification()' class='button buttonBlue' value='Resend verification email.' /></td>
                        </tr>
                    </tbody>
                </table>";
            }
